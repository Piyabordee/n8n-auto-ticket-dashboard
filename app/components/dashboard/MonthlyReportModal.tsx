...
export default function MonthlyReportModal({
  ...
  // Handle config save
  const handleConfigSave = useCallback((updated: ReportSectionConfig[]) => {
    setSections(updated)
        ...
        <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-neutral-200 flex items-center justify-between gap-2 no-print">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button
              ...
              className="px-3 py-1.5 bg-neutral-200 text-neutral-700 rounded-lg hover:bg-neutral-300 transition-colors text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 flex items-center gap-1.5"
              aria-label="ตั้งค่ารายงาน"
            >
